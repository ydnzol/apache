...
ALL : ".\mod_proxy_http.rc" "$(OUTDIR)\mod_proxy_http.so"

!ELSE 

ALL : "mod_proxy - Win32 Release" "libhttpd - Win32 Release" "libaprutil - Win32 Release" "libapr - Win32 Release" ".\mod_proxy_http.rc" "$(OUTDIR)\mod_proxy_http.so"
...
CLEAN :
!ENDIF 
	-@erase "$(INTDIR)\mod_proxy_http.idb"
	-@erase "$(INTDIR)\proxy_http.obj"
	-@erase "$(OUTDIR)\mod_proxy_http.exp"
	-@erase "$(OUTDIR)\mod_proxy_http.lib"
	-@erase "$(OUTDIR)\mod_proxy_http.map"
	-@erase "$(OUTDIR)\mod_proxy_http.so"
	-@erase ".\mod_proxy_http.rc"

"$(OUTDIR)" :
    if not exist "$(OUTDIR)/$(NULL)" mkdir "$(OUTDIR)"

CPP=cl.exe
CPP_PROJ=/nologo /MD /W3 /O2 /I "../../include" /I "../../srclib/apr/include" /I "../../srclib/apr-util/include" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\mod_proxy_http" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib ws2_32.lib mswsock.lib /nologo /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\mod_proxy_http.pdb" /map:"$(INTDIR)\mod_proxy_http.map" /machine:I386 /out:"$(OUTDIR)\mod_proxy_http.so" /implib:"$(OUTDIR)\mod_proxy_http.lib" /base:@..\..\os\win32\BaseAddr.ref,mod_proxy_http 
LINK32_OBJS= \
...
ALL : "mod_proxy - Win32 Debug" "libhttpd - Win32 Debug" "libaprutil - Win32 Debug" "libapr - Win32 Debug" ".\mod_proxy_http.rc" "$(OUTDIR)\mod_proxy_http.so"
...
CPP=cl.exe
CPP_PROJ=/nologo /MDd /W3 /GX /Zi /Od /I "../../include" /I "../../srclib/apr/include" /I "../../srclib/apr-util/include" /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\mod_proxy_http" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib ws2_32.lib mswsock.lib /nologo /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\mod_proxy_http.pdb" /map:"$(INTDIR)\mod_proxy_http.map" /debug /machine:I386 /out:"$(OUTDIR)\mod_proxy_http.so" /implib:"$(OUTDIR)\mod_proxy_http.lib" /base:@..\..\os\win32\BaseAddr.ref,mod_proxy_http 
LINK32_OBJS= \
	"$(INTDIR)\proxy_http.obj" \
